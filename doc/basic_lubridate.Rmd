...
- Periods: human units like weeks and months. Unlike seconds, years and months can vary because of different days in a month, leap year, and daylight savings time. Period allows adding 1 month to 1st February and become 1st March; it allows the calculation in calendar or clock time rather than in seconds.
...
You can add periods to dates. Compared to durations, periods are more likely to do what you expect:
...
You can also add and multiple periods.
